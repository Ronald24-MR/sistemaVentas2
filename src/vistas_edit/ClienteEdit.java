...
public class ClienteEdit extends javax.swing.JDialog {
    ...
    public void cargarTabla(){
        ...
        String nombreColumnas[] = {"ID","DNI","NOMBRES","DIRECCION","ESTADO"};
        ...
        for (int i = 0; i < lista.size(); i++) {
            ...
            Object fila[] = {cl.getIdCliente(),cl.getDni(),cl.getNombres(),cl.getDireccion(),cl.getEstado()};
            modelo.addRow(fila);
        }
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        // TODO add your handling code here:
            ...
            Cliente clien = c.findCliente(codigo);
