 ...
 * @author Ronald
 */
public class VendedorEdit extends javax.swing.JDialog {
    VendedorJpaController v = new VendedorJpaController();
    /**
     * Creates new form VendedorEdit
     */
    public VendedorEdit(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void jLabel8MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel8MouseClicked
        ...
        Vendedor vendedor = v.findVendedor(codigo);
        ...
        try{
            v.edit(vendedor);
            JOptionPane.showMessageDialog(this, "Se actualizo el registro correctamente");
            cargarTabla();
        }catch(Exception ex){
            JOptionPane.showMessageDialog(null,"Se presento un error al actualizar el registro");
    ...
    private void jLabel11MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel11MouseClicked
        ...
        if(fila==-1){
            ...
            if(fila>=0){
                ...
                Vendedor ven = v.findVendedor(codigo);
                
                txtDni.setText(ven.getDni());
                txtNombres.setText(ven.getNombres());
                txtTelefono.setText(ven.getTelefono());
                txtUser.setText(ven.getUser());
                txtEstado.setSelectedItem(ven.getEstado());
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VendedorEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VendedorEdit dialog = new VendedorEdit(new javax.swing.JFrame(), true);
